...
<form class="form-horizontal" id="formulario_reporte" method="post" action="clases/reporte/maquinaria-excel.php">
 
<div class="modal-header">
   <h4 class="modal-title">Reporte Horas Maquinaria</h4>
</div>
<br>
 ...
 <div
  class="modal-footer">
        ...
        <div class="col-lg-5">
          ...
          <button type="button" id="boton_buscar" class="btn btn-primary" onclick="reporte('maquinaria')">Buscar</button>   
          </div>
        </div>
      </div>  
  </div>
