...
<div class="modal-header">
   <h4 class="modal-title">Reporte Liquidaciones</h4>
</div>
<br>
 ...
 <div
  class="modal-footer">
        ...
        <div class="col-lg-5">
          ...
          <button type="button" id="boton_buscar" class="btn btn-primary" onclick="reporte('liquidacion')">Buscar</button>   
          </div>
        </div>
      </div>  
  </div>
