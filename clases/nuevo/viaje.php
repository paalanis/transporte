...
?>
<form class="form-horizontal" id="formulario_nuevo" role="form" onsubmit="event.preventDefault(); nuevo('viaje')">

 <div class="row">
 <div class="col-lg-2"><h4><span class="label label-default">Nuevo Viaje</span></h4><br></div> 
 <div class="col-lg-8">
   ...
   <fieldset>
     ...
     <div class="form-group form-group-sm">
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-4">
          <input type="number" min="0" class="form-control" autocomplete="off" id="dato_remito" placeholder="Número" value="" aria-describedby="basic-addon1" required>
        </div>
      ...
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-3">
          <input type="text" class="form-control" autocomplete="off" id="dato_patente-1" placeholder="Patente chasis" value="" aria-describedby="basic-addon1" required disabled>
        </div>
        <div class="col-lg-3">
          <input type="text" class="form-control" autocomplete="off" id="dato_patente-2" placeholder="Patente equipo" value="" aria-describedby="basic-addon1" required disabled>
        </div>
      </div>  
      <div class="form-group form-group-sm">
        ...
        <div class="col-lg-3">
          <input type="number" class="form-control" autocomplete="off" id="dato_cantidad" min="0" placeholder="Cantidad" value="" aria-describedby="basic-addon1" required disabled>
        </div>
        <label  class="col-lg-3 control-label" style="text-align: right;">DESCARGA MANUAL</label>
        <div class="col-lg-2">
          <input type="checkbox" class="form-control" autocomplete="off" id="dato_manual" value="0" aria-describedby="basic-addon1" disabled>
        </div>
      </div>
      <div class="form-group form-group-sm">
        <label  class="col-lg-2 control-label" style="text-align: right;">KILÓMETROS</label>
        <div class="col-lg-4">
          <input type="number" class="form-control" min="1" autocomplete="off" id="dato_km" value="" aria-describedby="basic-addon1" required>
        </div>
